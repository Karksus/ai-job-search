---
description: Full application workflow — evaluates fit, drafts CV + cover letter, reviews, compiles PDFs, ATS check
---
...
- Any mention of agentic coding or AI tooling must reference the assistant being used (e.g. **OpenCode**, **Claude Code**, etc.)
