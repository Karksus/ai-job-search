...
>
> I'll help you build your professional profile so your AI assistant can evaluate job postings, tailor CVs, write cover letters, and prepare you for interviews.
>
...
Then proceed to Step 3 to populate the non-skill files (`CLAUDE.md`, `cv/main_example.tex`, `.claude/skills/scrape/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
